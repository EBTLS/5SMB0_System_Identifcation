% Function which determines the estimate of cov(Ghat) in the frequency domain (see slide 84)
...
% "w" is a vector containing the frequencies at which you want cov(hatG) to be evaluated. This vector can be e.g. generated by the Matlab-function "logspace"
%
%
% Output arguments:
%
